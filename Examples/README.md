# XACML2mCRL2
*********************************************
This folder contains a few examples used for testing **XACML2mCRL2**.

*XACML Policies for conformance tests* folder contains OASIS XACML Committee's 2.0 version of conformance tests upgraded to conform to the XACML 3.0 standard, taken from 
...
*XACML Policies generated using XACBench* folder contains a few policies generated using *xacBench*: **https://github.com/nassirim/xacBench**
